...
#pragma warning disable CS0109 // Disable warning about redundant 'new' keyword
    ...
    public new class PropertyName : global::Godot.CharacterBody3D.PropertyName {
        /// <summary>
        /// Cached name for the 'Rig' property.
        /// </summary>
        public new static readonly global::Godot.StringName @Rig = "Rig";
        /// <summary>
    ...
    {
        if (name == PropertyName.@Rig) {
            this.@Rig = global::Godot.NativeInterop.VariantUtils.ConvertTo<global::Godot.Node3D>(value);
            return true;
        }
        if (name == PropertyName.@ActiveHand) {
            this.@ActiveHand = global::Godot.NativeInterop.VariantUtils.ConvertTo<global::EItem>(value);
            return true;
        }
        if (name == PropertyName.@MainHand) {
            this.@MainHand = global::Godot.NativeInterop.VariantUtils.ConvertTo<global::EItem>(value);
            return true;
        }
        if (name == PropertyName.@Offhand) {
            this.@Offhand = global::Godot.NativeInterop.VariantUtils.ConvertTo<global::EItem>(value);
            return true;
        }
    ...
    {
        if (name == PropertyName.@Rig) {
            value = global::Godot.NativeInterop.VariantUtils.CreateFrom<global::Godot.Node3D>(this.@Rig);
            return true;
        }
        if (name == PropertyName.@ActiveHand) {
            value = global::Godot.NativeInterop.VariantUtils.CreateFrom<global::EItem>(this.@ActiveHand);
            return true;
        }
        if (name == PropertyName.@MainHand) {
            value = global::Godot.NativeInterop.VariantUtils.CreateFrom<global::EItem>(this.@MainHand);
            return true;
        }
        if (name == PropertyName.@Offhand) {
            value = global::Godot.NativeInterop.VariantUtils.CreateFrom<global::EItem>(this.@Offhand);
            return true;
        }
    ...
    internal new static global::System.Collections.Generic.List<global::Godot.Bridge.PropertyInfo> GetGodotPropertyList()
    {
        ...
        properties.Add(new(type: (global::Godot.Variant.Type)24, name: PropertyName.@Rig, hint: (global::Godot.PropertyHint)34, hintString: "Node3D", usage: (global::Godot.PropertyUsageFlags)4102, exported: true));
